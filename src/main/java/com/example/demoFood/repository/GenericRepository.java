...
import com.example.demoFood.helper.ConnectionHelper;
import com.example.demoFood.helper.SQLConstant;
...
// có thể nhận nhiều class được đặt annotation là @Entity
public class GenericRepository<T> {
    ...
    public boolean save(T obj) {
        try {
            ...
            strQuery.append(SQLConstant.INSERT_INTO);
